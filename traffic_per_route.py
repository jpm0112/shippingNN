...
df.drop(columns=['US$ FOB', 'US$ FLETE', 'US$ SEGURO', 'US$ CIF', 'NUM DE ITEM', 'CANTIDAD', 'UNIDAD', 'TEU_factor'],
        inplace=True)
...
msc_variants = [name for name in df['COMPANIA DE TRANSPORTE'].unique() if
                'MSC' in name or 'MEDITERRANEAN' in name or 'MEDIT.' in name]
...
replacements = {
    'WAN HAI': ['WAN HAI. NAVEPAC', 'WAN HAI LINES', 'WAN HAI LINE', 'WAN HAI LINES LTD', 'WAN HAI LINES LTDA',
                'WHL WAN HAI LINE', 'WAN HAI LINE LINES L'],
    'COSCO': ['COSCO SHIPPING', 'COSCO SHIPPING LINE', 'COSCO SHIPPING CO', 'COSCO SHIPPING LINES',
              'COSCO SHIPPIN LINES', 'COSCO SHIPPING BULK', 'COSCO CHILE', 'COSCO CONTAINER', 'COSCO LINE',
              'COSCO LINE.'],
    'CMA CGM': ['CMA CGM', 'CMA CGM CHILE', 'CMA-CGM', 'CMACGM', 'CMA CGM S.A.', 'CMA CGM CHILR LTDA', 'CMA  CGM',
                'CMA CMG'],
    'EVERGREEN': ['EVERGREEN  INTL.', 'EVERGREEN MARINE', 'EVERGREEN LINE', 'EVERGREEN CHILE', 'EVERGREEN INTL.',
                  'EVER GREEN', 'EVERGREEN SHIPPING A', 'EVERGEEN SHIPPING AG', 'EVERGREEN  LINE'],
    'ONE': ['O.N.E.', 'ONE OCEAN', 'OCEAN NETWORK', 'OCEAN NEXTWORK EXPRE', 'OCEAN NETWORK EXP.',
            'ONE OCEAN NETWORK EX', 'ONE NETWORK EXPRESS', 'ONE - OCEAN NETWORK', 'ONE-OCEAN NETWORK EX',
            'OCEAN  NETWORK EXP', 'OCEAN  NETWORK EXPRE', 'OCEAN NERTWORK EXPRE', 'ONE LINE', 'ONE LINES',
            'OCEAN EXPRESS', 'OCEAN NET.EXPRESS'],
    'YANG MING': ['YANG MING', 'YAN MING', 'YANGMING', 'YANG MING MARINE', 'YANG MING LINE', 'YANG  MING'],
    'HAPAG-LLOYD': ['HAPAG LLOYD', 'HAPAG LLOYD CHILE', 'HAPAG LLOYD SPA', 'HAPAG LLOYD HAMBURGO',
                    'HAPAG LLOYD HAMBURG', 'HAPAG-LLOYD', 'HAPAG LLO'],
    'PACIFIC INT. LINE': ['PACIFIC INT LINE', 'PACIFIC INT.LINE', 'PACIFIC INTER. LINE', 'PACIFIC INTL LINE',
                          'PACIFIC INTER LINE',
                          'PACIFIC INT. LINES(P)', 'PACIFIC INTL.LINES(P', 'PACIFIC INT. LINES (',
                          'PACIFIC INT. LINES L',
                          'PACIFIC INT,LINE', 'PACIFIC INTERNAT.LIN', 'PACIFIC INTERN.LINE', 'PACIFIC INTER.LINES',
                          'PACIFIC INTERNATIONA'],
    'HYUNDAI': ['HYUNDAI MERCHANT', 'HYUNDAI MERCHANT MAR', 'HMM HYUNDAI MERCHANT', 'HYNDAI MERCHANT MARI', 'HMM',
                'HYUNDAY'],
    'MAERSK': ['MAERKS CHILE S.A.', 'MAERKS LINE S.A'],
    'MSC': ['MEDITERR.SHIPPING CO', 'M.S.C.', 'MEDITERRAN SHIPPING', 'MEDITERRANEA SHIPPIN', 'MED.SHIPP.',
            'MEDITER.SH.CO.S.A.', 'MED.SHIPPING COMPANY', 'MARITIMA DEL MEDITER', 'MEDITERRANEO CARGO S'],
    'PIL': ['PIL-PACIFIC INTERNAT', 'PIL PACIFIC INTERNAT', 'PIL (PACIFIC INTERNA', 'P.I.L.', 'P.I.L',
            'PACIFIC INT. LINE', 'PACIFIC INT. LINES(P', 'PACIFIC INT. LINE', 'PACIFIC INT. LINE', 'PACIFIC INT. LINE'],
    'OOCL': ['O.O.C.L.', 'OOCL ORIENT OVERSEAS', 'OOCL  ORIENT OVERSEA', 'ORIENT OVERSEAS CONT', 'ORIENTAL OVERSEAS CO',
             'OOCL SHIPPING', 'OOCL CONT LINE', 'OOCL LOGISTICS LIMIT'],
    ...
    'AGUNSA': ['AGENCIA UNIVERSALES', 'AGENCIAS UNIVERSALES', 'AGENCIAS UNIVER', 'AGUNSA UNIVERSALES',
               'AGUNSA LOGISTICS']
}
